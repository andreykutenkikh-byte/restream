...
_SELF_TEST_STAGE_CODES = {
    ...
    "auth-n-child": "relay_self_test_auth_exclusivity_normalizer_child_exit_failed",
    "auth-n-start": "relay_self_test_auth_exclusivity_normalizer_start_timeout_failed",
    "auth-n-blind": "relay_self_test_auth_exclusivity_normalizer_metrics_blind_failed",
    "auth-n-out-id": "relay_self_test_auth_exclusivity_normalizer_output_identity_failed",
    "auth-n-out-reg": "relay_self_test_auth_exclusivity_normalizer_output_regression_failed",
    "auth-n-fallback": "relay_self_test_auth_exclusivity_normalizer_output_fallback_failed",
    "auth-n-in-time": "relay_self_test_auth_exclusivity_normalizer_ingest_timing_failed",
    "auth-n-in-miss": "relay_self_test_auth_exclusivity_normalizer_ingest_missing_failed",
    ...
    "cont-kick": "relay_self_test_continuity_disconnect_failed",
    "cont-final": "relay_self_test_continuity_final_slate_failed",
    "cont-capture": "relay_self_test_continuity_capture_failed",
    "cont-ledger": "relay_self_test_continuity_ledger_failed",
    "cont-reader": "relay_self_test_continuity_reader_failed",
    "sink-format": "relay_self_test_sink_format_failed",
    "sink-gop": "relay_self_test_sink_gop_failed",
    "sink-decode": "relay_self_test_sink_decode_failed",
    "sink-video": "relay_self_test_sink_video_failed",
    "sink-audio": "relay_self_test_sink_audio_failed",
    "sink-timestamps": "relay_self_test_sink_timestamps_failed",
